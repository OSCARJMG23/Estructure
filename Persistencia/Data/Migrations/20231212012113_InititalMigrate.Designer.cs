...
namespace Persistencia.Data.Migrations
{
    ...
    [Migration("20231212012113_InititalMigrate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.Entities.Departamento", b =>
                {
                    ...
                    b.Property<int?>("IdPaiss")
                        .HasColumnType("int")
                        .HasColumnName("id_Paiss");
                    ...
                    b.HasIndex(new[] { "IdPaiss" }, "id_Paiss");
            ...
            modelBuilder.Entity("Dominio.Entities.Pais", b =>
                {
                    ...
                    b.ToTable("Paiss", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            NombrePaiss = "Colombia"
                        });
                });
            ...
            modelBuilder.Entity("Dominio.Entities.Departamento", b =>
                {
                    b.HasOne("Dominio.Entities.Pais", "IdPaissNavigation")
                        .WithMany("Departamentos")
                        .HasForeignKey("IdPaiss")
                        .HasConstraintName("departamento_ibfk_1");

                    b.Navigation("IdPaissNavigation");
                });
